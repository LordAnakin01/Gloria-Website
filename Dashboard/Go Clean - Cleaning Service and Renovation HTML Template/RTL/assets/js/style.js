...
/* -------------------- Clean-Plan Slider -------------------- */
$(document).ready(function () {
  $(".clean_slider_list.carousel-rtl").slick({
    centerMode: true,
    centerPadding: "15px",
    slidesToShow: 6,
    slidesToScroll: 1,
  ...
  $(".client_testimonials_list.carousel-rtl").slick({
    centerMode: true,
    centerPadding: "0px",
    slidesToShow: 3,
    slidesToScroll: 1,
  ...
  /* -------------------- Our-Work Slider -------------------- */
  $(".work_slider_1_list.carousel-rtl").slick({
    dots: false,
    arrows: true,
    slidesToShow: 4,
    slidesToScroll: 1,
  ...
  $(".work_slider_2_list.carousel-rtl").slick({
    dots: false,
    arrows: true,
    slidesToShow: 4,
    slidesToScroll: 1,
  ...
  $(".banner_slider_area.carousel-rtl").slick({
    slidesToShow: 1,
    slidesToScroll: 1,
    dots: false,
    arrows: true,
  ...
  $(".client_slider_3_list.carousel-rtl").slick({
    slidesToShow: 1,
    slidesToScroll: 1,
    dots: true,
    arrows: false,
  ...
  $('.single_project_img_slider_item_sub.carousel-rtl').slick({
    slidesToShow: 1,
    slidesToScroll: 1,
    arrows: true,
    dots: false,
  ...
  $('.single_project_img_slider_item_nav.carousel-rtl').slick({
    slidesToShow: 3,
    slidesToScroll: 1,
    asNavFor: '.single_project_img_slider_item_sub.carousel-rtl',
    dots: false,
    arrows: false,
    focusOnSelect: true,
    rtl: true,
  ...
  /* -------------------- Blogs Slider -------------------- */
  $(".our_blogs_box_slider_list.carousel-rtl").slick({
    slidesToShow: 1,
    slidesToScroll: 1,
    dots: false,
    arrows: true,
...
$(document).ready(function () {
  $(".client_testimonials_list_2.carousel-rtl").slick({
    slidesToShow: 1,
    slidesToScroll: 1,
    dots: false,
    arrows: true,
...
/* -------------------------------------  Timeline Button ------------------------------------- */
$(document).ready(function () {
  $(".timelinetab_slider_tabs.carousel-rtl").slick({
    slidesToShow: 4,
    slidesToScroll: 1,
    dots: false,
    arrows: true,
...
/* -------------------------------------  Timeline Button ------------------------------------- */
$(document).ready(function () {
  $(".our_services_slider_tabs.carousel-rtl").slick({
    slidesToShow: 4,
    slidesToScroll: 1,
    dots: false,
    arrows: true,
